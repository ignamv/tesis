...
capa de plástico,
para frenar la partícula minimizando la producción de radiación X de frenado.
...
Esto permite mover la fuente con un interruptor de manera fácil, rápida y repetible.
\begin{figure}[H]
    \centering
...
Esto brinda mayor confianza en que su operación no es peligrosa.
