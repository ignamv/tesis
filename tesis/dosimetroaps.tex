...
una juntura p-n.
El cátodo de la juntura está aislado eléctricamente para que la carga no fugue
y se pierda (D1 en \figref{fig:aps}).
...
\fig{energia1electron}{figuras/aps/deposicion1electron_todos.pdf}{Distribución
    de probabilidad para la energía depositada en el sensor (eje X).
...
a su capacidad.
En este caso la carga fue generada por la radiación,
y la tensión es la señal medida que queremos maximizar.
...
como del mismatch entre los seguidores.
...
desaparecen al promediarse sobre mucha área.
