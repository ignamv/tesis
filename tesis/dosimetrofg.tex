...
como una placa de un capacitor normal.
...
a través del óxido del inyector.
Al aplicar tensión al inyector,
parte de esta tensión cae sobre 
la capacidad de gate del inyector $C_I$
y parte sobre la capacidad de well $C_W$ y del lector $C_R$.
Minimizando $C_I$, se maximiza la tensión a través del inyector
y por lo tanto se logra la mayor corriente de túnel.}

% TODO Aplicamos una tensión entre el gate y un transistor inyector.
