...
La geometría y concentraciones de estas zonas 
son lo que define cada tipo de dispositivo 
...
Una técnica es exponer el sustrato a un gas
para que haya difusión de átomos del gas al sustrato.
La otra es ionizar las impurezas 
y acelerarlas mediante campos eléctricos hacia el sustrato.
Allí penetran una profundidad que puede controlarse 
variando su energía\cite{campbell_science_2001}.


La forma en que las impurezas introducen portadores es ionizándose al
capturar o liberar un electrón.
...
sumado a una carga fija +1, y un electrón/hueco.
